...
//---- indicator lines
   ...
   AlertPrefix=Symbol()+" ("+GetTimeFrameStr()+") Stoch :  ";
...
// Alert
      ...
      if ((BufferK[i] < BufferD[i]) && (BufferK[i+1] > BufferD[i+1])) {
                   if (AlertOn && NewBar()) {
                      Alert("Stochastic (", Symbol(), ", ", Period(), ")  -  BUY!!!");
                   }   
      }
      else if ((BufferK[i] < BufferD[i]) && (BufferK[i+1] > BufferD[i+1])) {
                   if (AlertOn && NewBar()) {
                      Alert("Stochastic (", Symbol(), ", ", Period(), ")  -  SELL!!!");
                   }   
      }
	}
