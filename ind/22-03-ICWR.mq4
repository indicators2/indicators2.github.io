...
//|                   Mods and Stuff added by Linuxser for Forex TSD |
//+------------------------------------------------------------------+
         ...
         if(LastActive > 0)
         {
            if(MathAbs(LastActive - ExtMapBuffer[shift]) >= RequiredWaveHeight*Point)
            {
               ...
               if(ObjectFind("ActiveWave") != 0)
               {
                  ...
                  ObjectSet("ActiveWave", OBJPROP_WIDTH, 2);
               ...
               FiboHC = FiboL + (FiboH - FiboL)*0.786;
               FiboHC = FiboL + (FiboH - FiboL)*0.886;
...
/*                ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+0, FiboL);
                  ...
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+0, 0); ObjectSetFiboDescription("Fibo", 0, "Beginning 0.0");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+1, 0.236); ObjectSetFiboDescription("Fibo", 1, "0.236 Lower Confirmation");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+2, 0.382); ObjectSetFiboDescription("Fibo", 2, "0.382 Lower Retracement");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+3, 0.5); ObjectSetFiboDescription("Fibo", 3, "0.500 Middle Retracement");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+4, 0.618); ObjectSetFiboDescription("Fibo", 4, "0.618 Upper Retracement");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+5, 0.786); ObjectSetFiboDescription("Fibo", 5, "0.786 Upper Confirmation");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+6, 0.886); ObjectSetFiboDescription("Fibo", 6, "0.886 Upper Confirmation");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+7, 1); ObjectSetFiboDescription("Fibo", 7, "1.000 Full Retracement");
                  ObjectSet("Fibo", OBJPROP_FIRSTLEVEL+8, 1.618); ObjectSetFiboDescription("Fibo", 8, "1.618 First Projection");
